...
__export(index_exports, {
  ...
  decodeObjectId12: () => decodeObjectId12,
  decodeObjectId8: () => decodeObjectId8,
  encodeBase32: () => encodeBase32,
  encodeObjectId12: () => encodeObjectId12,
  encodeObjectId8: () => encodeObjectId8
});
...
var import_flatbuffers = require("flatbuffers");
var flexbuffers = __toESM(require("flatbuffers/js/flexbuffers.js"), 1);
...
function parseRepo(data) {
  ...
  if (header.compression === 1 /* Zstd */) {
    fbData = (0, import_fzstd.decompress)(fbData);
  }
  const bb = new import_flatbuffers.ByteBuffer(fbData);
...
var import_fzstd2 = require("fzstd");
...
var import_flatbuffers2 = require("flatbuffers");
...
function parseSnapshot(data) {
  const bb = new import_flatbuffers2.ByteBuffer(data);
...
var import_flatbuffers3 = require("flatbuffers");
...
function parseManifest(data) {
  const bb = new import_flatbuffers3.ByteBuffer(data);
...
var flexbuffers2 = __toESM(require("flatbuffers/js/flexbuffers.js"), 1);
function deserializeMetadata(items, specVersion) {
  const result = /* @__PURE__ */ Object.create(null);
  for (const item of items) {
    result[item.name] = specVersion === 1 /* V1_0 */ ? (0, import_msgpack.decode)(item.value) : flexbuffers2.toObject(
...
var import_flatbuffers4 = require("flatbuffers");
...
function parseTransactionLog(data) {
  const bb = new import_flatbuffers4.ByteBuffer(data);
...
var ReadSession = class _ReadSession {
  ...
  static async loadSnapshot(storage, snapshotId, options) {
    ...
    if (header.compression === 1 /* Zstd */) {
      flatbufferData = (0, import_fzstd2.decompress)(flatbufferData);
    }
    return {
